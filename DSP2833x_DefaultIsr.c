...
//#include "DeclaraFun.h"		//Agregado por Ross para hacer pruebas
//#include "Variables.h"		//Agregado por Ross para hacer pruebas
//char *msg;
...
//char *msgt;
  // Next two lines for debug only to halt the processor here
  // Remove after inserting ISR Code
	//msg = "\r\n\n\nIllegalisr!\0";     // Aggregate por Ross
	//scic_msg(msg);				  // para hacer pruebas
  asm("          ESTOP0");
  for(;;);
